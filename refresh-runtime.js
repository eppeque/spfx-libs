(function (global, factory) {
  ...
  function createSignatureFunctionForTransform() {
    ...
    return function (type, key, forceReset, getCustomHooks) {
      if ('string' === typeof key)
        return (
          savedType ||
            ((savedType = type), (hasCustomHooks = 'function' === typeof getCustomHooks)),
          null == type ||
            ('function' !== typeof type && 'object' !== typeof type) ||
  ...
  function injectIntoGlobalHook(globalObject) {
    ...
    if (hook.isDisabled)
      ...
      hook.onScheduleFiberRoot = function (id, root, children) {
        isPerformingRefresh ||
          (failedRoots.delete(root), null !== rootElements && rootElements.set(root, children));
        ...
        if (void 0 !== helpers) {
          ...
          null !== alternate
            ? ((alternate =
              ...
              (helpers = null != helpers.memoizedState && null != helpers.memoizedState.element),
              !alternate && helpers
                ? (mountedRoots.add(root), failedRoots.delete(root))
                : (alternate && helpers) ||
                  (alternate && !helpers
                    ? (mountedRoots.delete(root),
                      didError ? failedRoots.add(root) : helpersByRoot.delete(root))
                    : alternate || helpers || (didError && failedRoots.add(root))))
  ...
  function isReactRefreshBoundary(moduleExports) {
    if (isLikelyComponentType(moduleExports)) return true;
    ...
    for (const key in moduleExports) {
      ...
      if (!isLikelyComponentType(exportValue)) areAllExportsComponents = false;
    }
  ...
  const enqueueUpdate = debounce(performReactRefresh, 30);
  ...
  exports.isReactRefreshBoundary = isReactRefreshBoundary;
